...
function PrivacyPage() {
    ...
    const ToggleItem = ({ title, description, state, setState }) => (
        <div className="flex items-center justify-between p-4 border rounded-2xl bg-white-blue/20 mb-4 transition-all hover:border-blue">
            ...
            >
                <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ${state ? 'translate-x-6' : 'translate-x-1'}`} />
            </button>
        </div>
    );
        ...
        <AppLayout>
            <article className="p-6 rounded-3xl border max-w-7xl mx-auto mt-10 flex flex-row gap-16">
                ...
                <section className="flex flex-col w-full">
                    ...
                    <div className="mb-8">
                        <h2 className="text-sm font-bold uppercase tracking-wider text-blue mb-4">1. Gegevens & Tracking</h2>
                        <ToggleItem
                    ...
                    <div className="mb-8">
                        <h2 className="text-sm font-bold uppercase tracking-wider text-blue mb-4">2. Zichtbaarheid & Sociaal</h2>
